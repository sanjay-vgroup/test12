...
class Companies extends \Magento\Framework\Model\AbstractExtensibleModel implements
    \Vgroup\SafetyHubApp\Api\Data\CompanyInterface
{
     ...
     * CMS page cache tag
     */
    const CACHE_TAG = 'safetyhubapp_companies';
    ...
    protected function _construct()
    {
        ...
        $this->_init('Vgroup\SafetyHubApp\Model\ResourceModel\Companies');
    }
