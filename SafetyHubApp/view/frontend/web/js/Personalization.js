        ...
        $(document).ready(function() {
           ...
           //updateStyleApp('<?= json_encode($company->getData()) ?>');
            $("#desktop_preview").on("click", function () { 
                var bgColor = '#' + $("#portal_bg_color").val();
                var fontColor = '#' + $("#portal_font_color").val();
            ...
            function updateStyle(bgColor, fontColor) {
                $(".page-title-wrapper").css('background-color', bgColor);
                $(".page-title-wrapper h1").css('color', fontColor);
                $(".button").css('background-color', bgColor);
                $(".button").css('color', fontColor);
                $("#account-nav ul li.current strong").css('background-color', bgColor);
                $("#account-nav ul li.current strong").css('color', fontColor);
                $("#account-nav ul li.current a").css('border-bottom-color', '#ccc');
                $("#account-nav ul li a").hover(function () {
                    $(this).css("background-color", bgColor);
                    $(this).css("color", fontColor);
                }, function () {
                    $(this).css("background-color", '#F2F2F2');
                    $(this).css("color", '#636363');
                    $("#account-nav ul li.current a").css('background-color', bgColor);
                    $("#account-nav ul li.current a").css('color', fontColor);
                });
            }
            // Mobile App theme
            function updateStyleApp(theme) {
                var obj = $.parseJSON(theme);
                $("#phone-container .topBar").css("background-color", '#' + obj.panel_bg_color);
                $("#phone-container .topBar h1").css("color", '#' + obj.navigation_bar_font_color);
                $(".btn-proceed").css("background-color", '#' + obj.medium_action_button_bg_color);
                $(".btn-proceed").css("color", '#' + obj.medium_action_button_font_color);
                $(".btn-draft").css("background-color", '#' + obj.small_action_button_bg_color);
                $(".btn-draft").css("color", '#' + obj.small_action_button_font_color);
                $(".btn-edit").css("background-color", '#' + obj.small_action_button_bg_color);
                $(".btn-edit").css("color", '#' + obj.small_action_button_font_color);
                ...
                $(".btn-register").css("background-color", '#' + obj.large_action_button_bg_color);
                $(".btn-register").css("color", '#' + obj.large_action_button_font_color);
                return false;
